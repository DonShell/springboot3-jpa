...
public class testConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		orderList.add( new Order(null, Instant.parse("2019-06-20T19:53:07Z"), usersList.get(1)));
		orderList.add( new Order(null, Instant.parse("2019-07-21T03:42:10Z"), usersList.get(2)));
		orderList.add( new Order(null, Instant.parse("2019-07-22T15:21:22Z"), usersList.get(0)));
		orderList.add( new Order(null, Instant.parse("2019-08-07T14:21:20Z"), usersList.get(1)));
		orderList.add( new Order(null, Instant.parse("2019-08-07T14:25:22Z"), usersList.get(1)));
		orderList.add( new Order(null, Instant.parse("2019-09-07T15:04:20Z"), usersList.get(3))); 
